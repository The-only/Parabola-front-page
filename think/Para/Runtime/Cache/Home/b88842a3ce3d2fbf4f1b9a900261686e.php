...
<div class="content container">
	...
	<div class="row cont_head">
		<h3 class="text-muted col-md-7">排行榜</h3>
	</div>
	<!-- /.conthead -->
	<div class="main">
	...
	<li>
      ...
      <!-- ownInfoModal -->
 <div class="modal fade" id="otherInfo" tabindex="-1" role="dialog" aria-labelledby="otherInfoLabel" aria-hidden="true">
 	<div class="modal-dialog lr_pos diawidth">
 		<div class="modal-content">
 			<div class="modal-header">
 				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
 				<h4 class="modal-title" id="otherInfoLabel">个人信息</h4>
 			</div>
 			<div class="modal-body">
 				<div class="pre-scrollable detail_info">
...
<table class="table table-hover table-bordered">
	...
	<tr>
		<td>1</td>
		<td>
			<a href="" class="userinfo" title="34" data-toggle="modal" data-target="#otherInfo">xiefeng</a>
		</td>
		<td>12-34-04 89:87:89</td>
		<td>100</td>
		<td>200</td>
		<td>30.99%</td>
	</tr>
	<tr>
		<td>2</td>
		<td>
			<a href="" class="userinfo" title="34" data-toggle="modal" data-target="#otherInfo">fffff</a>
		</td>
		<td>12-34-04 89:87:89</td>
		<td>100</td>
		<td>200</td>
